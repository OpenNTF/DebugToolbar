...
public class DebugToolbar extends AbstractCompiledPageDispatcher{
    ...
    public static class DebugToolbarPage extends AbstractCompiledPage {
        ...
        private UIComponent createDebugtoolbar(FacesContext context, 
            ...
            String sourceId = "debugToolbar/xp:this.styleClass[1]/text()";
            String styleClassExpr = "#{javascript:\"dBar bg \" + (dBar.isCollapsed() ? (compositeData.collapseTo == \"right\" ? \"collapsedRight\" : \"collapsedLeft\") : \"expanded \")}";
        ...
        private UIComponent createTd4(FacesContext context, 
            ...
            UIPassThroughTag component = new UIPassThroughTag();
            component.setTag("td");
            component.addAttribute("class", "wide");
            return component;
        }
        ...
        private UIComponent createText55(FacesContext context, 
            ...
            String valueExpr = "#{javascript:var rt = java.lang.Runtime.getRuntime();\n\tvar free = rt.freeMemory();\n\tvar total = rt.totalMemory();\n\tvar max = rt.maxMemory();\n\tvar used = total-free;\n\t\n\t\"<tr><td style=\\\"width: 150px;\\\"><div style=\\\"float:right; background: #D33939; width: 14px; height: 9px;\\\"></div>used</td><td>\" + dBar.getReadableSize(used) + \"</td></tr>\" +\n\t\"<tr><td style=\\\"width: 150px;\\\"><div style=\\\"float:right; background: #039B03; width: 14px; height: 9px;\\\"></div>free</td><td>\" + dBar.getReadableSize(free) + \"</td></tr>\" +\n\t\"<tr><td style=\\\"width: 150px;\\\"><div style=\\\"float:right; background: #D33939; width: 7px; height: 9px;\\\"></div><div style=\\\"float:right; background: #039B03; width: 7px; height: 9px;\\\"></div>total allocated</td><td>\" + dBar.getReadableSize(total) + \"</td></tr>\"\n\t}";
            ValueBinding value = evaluator.createValueBinding(result, valueExpr, sourceId,Object.class);
            result.setValueBinding("value", value);
            result.setEscape(false);
            Map<String,Object> attrs = getAttributes(result);
        ...
        private UIComponent createLink44(FacesContext context, 
            ...
            String renderedExpr = "#{javascript:!\"void\".equals( !dBar.getInspectorResultClassName() )}";
            ValueBinding rendered = evaluator.createValueBinding(result, renderedExpr, sourceId2,boolean.class);
            result.setValueBinding("rendered", rendered);
            setId(result, "link44");
        ...
        private UIComponent createLink7(FacesContext context, 
            ...
            String renderedExpr = "#{javascript:!\"void\".equals( !method.getReturnType().getCanonicalName() )}";
            ValueBinding rendered = evaluator.createValueBinding(result, renderedExpr, sourceId2,boolean.class);
            result.setValueBinding("rendered", rendered);
            setId(result, "link7");
        ...
        private UIComponent createLink45(FacesContext context, 
            ...
            String renderedExpr = "#{javascript:!\"void\".equals( field.getType().getCanonicalName() )}";
            ValueBinding rendered = evaluator.createValueBinding(result, renderedExpr, sourceId2,boolean.class);
            result.setValueBinding("rendered", rendered);
            setId(result, "link45");
