 ...
 */
package org.openntf.xsp.debugtoolbar.ssjs;
...
public class DebugToolbarFactory implements ILibraryFactory {
	private final static Map<String, String> _libs = new HashMap<String, String>();
	static {
		_libs.put("DebugToolbar.jss", "/org/openntf/xsp/debugtoolbar/ssjs/DebugToolbar.jss");
	}
